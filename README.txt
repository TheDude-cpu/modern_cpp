...
8. override, final [ok]:
    ...
    Mark getX() in Rectangle as final - error
...
10. noexcept [ok]:
    Mark some getArea() and getPerimeter() methods as noexcept (zrobione tylko dla Cicle/ dokończyć)
11. constexpr [ok]:
...
15. move semantics [ok]:
    Add move constructors and move assignment operators to all shapes. [tylko circle zrobione]
